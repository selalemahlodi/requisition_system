...
$css_version = filemtime('awaiting_dashboard.css'); 



$dashboard_stats = [
    ['label' => 'Dashboard', 'count' => '', 'color_class' => 'stat-dashboard-red'], 
    ['label' => 'Open', 'count' => 4, 'color_class' => 'stat-open-green'],
    ['label' => 'Approved', 'count' => 3, 'color_class' => 'stat-approved-blue'],
    ['label' => 'Rejected', 'count' => 2, 'color_class' => 'stat-rejected-brown'],
];


$requisition_summary = [
    ['id' => 5, 'description' => 'Table', 'date_created' => '24/08/2025', 'total' => 'R1000', 'status' => 'Rejected', 'row_class' => 'status-rejected'],
];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Cospharm - Awaiting Dashboard</title>
    <link rel="stylesheet" href="awaiting_dashboard.css?v=<?php echo $css_version; ?>">
</head>
<body>
