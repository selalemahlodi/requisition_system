...
$css_version = filemtime('approved_dashboard.css'); 
...
<head>
    ...
    <title>Cospharm - Approved Requisitions Dashboard</title>
    <link rel="stylesheet" href="approved_dashboard.css?v=<?php echo $css_version; ?>">
    </head>
<body>
