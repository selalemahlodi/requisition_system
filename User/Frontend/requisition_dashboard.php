...
$dashboard_stats = [
    ['label' => 'Open', 'count' => 4, 'color_class' => 'stat-open'],
...
$requisition_summary = [
    ['id' => 1, 'description' => 'Refund', 'date_created' => '20/08/2025', 'total' => 'R10', 'status' => 'Approved', 'row_class' => 'status-approved'],
    ['id' => 3, 'description' => 'Router', 'date_created' => '22/08/2025', 'total' => 'R120', 'status' => 'Awaiting', 'row_class' => 'status-awaiting'],
...
<head>
    ...
    <link rel="stylesheet" href="requisition_dashboard.css?v=<?php echo $css_version; ?>">
    </head>
<body>
