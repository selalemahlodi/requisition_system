...
$css_version = filemtime('rejected_dashboard.css'); 
...
<head>
    ...
    <title>Cospharm - Rejected Requisitions Dashboard</title>
    <link rel="stylesheet" href="rejected_dashboard.css?v=<?php echo $css_version; ?>">
</head>
<body>
